...
void leerCorreo(correo &, string, string);//son variables de referencia(&:amper) no direcciones 
...
int main(){
 ...
 cout<<"0. Salir"<<endl;
    ...
    leerCorreo(c.email, user, domain);
    leerContacto(c, nom, sex, edad, c.email);
}
            case 0:
...
void imprimeContacto(contactoEmail &c){
    ...
    cout<<"Edad: "<<c.edad<<endl;
    cout<<"Email: "<<c.email.user<<"@"<<c.email.domain<<endl;
>>>>>>> 25504e3963c5cdb9a676171e159fadea14d39bbd
}